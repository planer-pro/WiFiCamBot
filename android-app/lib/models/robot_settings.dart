...
class RobotSettings {
  ...
  // ---- таблицы-значения (синхронизированы с прошивкой) ----
  // Текстовые подписи к индексам — в core/l10n.dart (Strings), там же
  // переводы; индексы общие и обязаны совпадать с таблицами прошивки.
